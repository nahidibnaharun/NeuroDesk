...
export const NeuronIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M12 2a10 10 0 0 0-2 19.5v-1.5a8 8 0 1 1 4 0v1.5A10 10 0 0 0 12 2Z" />
    <path d="M12 13a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z" />
    <path d="m12 13-1.5 2.5" />
    <path d="m10.5 15.5 2 3" />
    <path d="m12 13 1.5 2.5" />
    <path d="m13.5 15.5-2 3" />
    <path d="m12 7-1.5-2.5" />
    <path d="m10.5 4.5 2-3" />
    <path d="m12 7 1.5-2.5" />
    <path d="m13.5 4.5-2-3" />
  </svg>
);
...
export const SparklesIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="m12 3-1.9 4.8-4.8 1.9 4.8 1.9 1.9 4.8 1.9-4.8 4.8-1.9-4.8-1.9L12 3z"></path><path d="M5 21v-3"></path><path d="M3 19h4"></path><path d="M19 5v3"></path><path d="M17 7h4"></path>
    </svg>
);
...
export const HistoryIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M3 3v5h5"></path><path d="M3.05 13A9 9 0 1 0 6 5.3L3 8"></path>
    </svg>
);
...
export const NotebookIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M2 6h4"/><path d="M2 10h4"/><path d="M2 14h4"/><path d="M2 18h4"/><rect width="16" height="20" x="4" y="2" rx="2"/><path d="M15 2v20"/></svg>
);
...
export const ScaleIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="m16 16 3-8 3 8c-2 1-4 1-6 0Z"/><path d="m2 16 3-8 3 8c-2 1-4 1-6 0Z"/><path d="M7 21h10"/><path d="M12 3v18"/><path d="M3 7h18"/>
    </svg>
);
...
interface AiTeacherIconProps extends IconProps {
  mood: 'neutral' | 'happy' | 'sad';
}

export const AiTeacherIcon: React.FC<AiTeacherIconProps> = ({ className, mood = 'neutral' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" className={className}>
        <g transform="translate(0, 4)">
            {/* Body */}
            <path d="M56,48.83a4,4,0,0,1-4,4H12a4,4,0,0,1-4-4V20.5a4,4,0,0,1,4-4H52a4,4,0,0,1,4,4Z" fill="#787ff6"/>
            {/* Screen */}
            <path d="M51,46.83H13a3,3,0,0,1-3-3V22.5a3,3,0,0,1,3-3H51a3,3,0,0,1,3,3v21.33A3,3,0,0,1,51,46.83Z" fill="#d3d3ff"/>
            {/* Eyes */}
            <circle cx="24" cy="32.83" r="3" fill="#3c434f" className="blinking-eye"/>
            <circle cx="40" cy="32.83" r="3" fill="#3c434f" className="blinking-eye"/>
            {/* Mouth - mood dependent */}
            <g style={{ transition: 'transform 0.3s ease, opacity 0.3s ease' }}>
                {mood === 'neutral' && <path d="M28,40.83h8a1,1,0,0,1,0,2H28a1,1,0,0,1,0-2Z" fill="#3c434f"/>}
                {mood === 'happy' && <path d="M38.89,38.83a1,1,0,0,0-1.78,0,5,5,0,0,1-8.22,0,1,1,0,1,0-1.78,0,7,7,0,0,0,11.78,0Z" fill="#3c434f"/>}
                {mood === 'sad' && <path d="M38.89,42.83a1,1,0,0,1-1.78,0,5,5,0,0,0-8.22,0,1,1,0,0,1-1.78,0,7,7,0,0,1,11.78,0Z" fill="#3c434f" />}
            </g>
             {/* Base */}
            <path d="M42.5,52.83H21.5a1,1,0,0,1,0-2h21a1,1,0,0,1,0,2Z" fill="#a6a6d6"/>
            <path d="M39,55.83H25a1,1,0,0,1,0-2H39a1,1,0,0,1,0,2Z" fill="#a6a6d6"/>
        </g>
    </svg>
);
...
export const RotateCwIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M21 2v6h-6"></path><path d="M3 12a9 9 0 1 1 9 9 9.75 9.75 0 0 1-6.74-2.74L3 12"></path>
  </svg>
);

export const SettingsIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 0 2.01l-.15.1a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.38a2 2 0 0 0-.73-2.73l-.15-.1a2 2 0 0 1 0-2.01l.15-.1a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z"></path><circle cx="12" cy="12" r="3"></circle>
  </svg>
);
